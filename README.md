...
| Dataset | Purpose |
|----------|---------|
| [Talk2Car](https://talk2car.github.io/) | In-domain training and evaluation |
| [BDD-X](https://bdd-x.github.io/) | Cross-domain retrieval and localization |
| [KITTI](https://www.cvlibs.net/datasets/kitti/eval_object.php) | Cross-domain localization |
